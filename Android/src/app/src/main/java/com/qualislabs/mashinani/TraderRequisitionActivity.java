...
public class TraderRequisitionActivity extends AppCompatActivity {
    private MaterialEditText mMaterialEditTextDate, mMaterialEditTextBags, mMaterialEditTextDeliveryLocation;
    ...
    private static final int PLACE_PICKER_REQUEST = 2766;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_trader_requisition);
        ...
        mMaterialEditTextDeliveryLocation = (MaterialEditText)findViewById(R.id.edit_delivery_location);
        mSpinnerProduce = (Spinner)findViewById(R.id.spinner_trader_produce);
        mTextInputEditTextInstructions = (TextInputEditText) findViewById(R.id.edit_trader_instructions);
        ...
        mMaterialEditTextDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DatePickerDialog datePickerDialog = new DatePickerDialog(TraderRequisitionActivity.this, date, mCalendar
        ...
        mRoundedButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String latLong = mMaterialEditTextDeliveryLocation.getText().toString();
                ...
                if (TextUtils.isEmpty(produce) || TextUtils.isEmpty(date) || TextUtils.isEmpty(bags)
                    ...
                    Toast.makeText(TraderRequisitionActivity.this,
                            "Kindly fill all details to proceed", Toast.LENGTH_LONG).show();
                } else if (Integer.parseInt(bags) < 5){
                    Toast.makeText(TraderRequisitionActivity.this,
                            "Number of bags can't be less than 5", Toast.LENGTH_LONG).show();
                }
                else {
                    mProgressDialog = new ProgressDialog(TraderRequisitionActivity.this,
        ...
        mMaterialEditTextDeliveryLocation.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                openPlacePickerView();
            }
    ...
    private void submitRequisition(String produce, int bags, String date, String instructions, String latLong) throws JSONException {
        ...
        reqDataMap.put("expectedDeliveryDate", date);
        reqDataMap.put("deliveryLocation", latLong);
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        if (jsonObject != null)
                        {
                            ...
                            Intent intent = new Intent(TraderRequisitionActivity.this,
                                    HomeActivity.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == PLACE_PICKER_REQUEST) {
            if (resultCode == RESULT_OK) {
                ...
                mMaterialEditTextDeliveryLocation.setText(latLngQueriedLocation.latitude + "," + latLngQueriedLocation.longitude);
            }
        }
    }
}